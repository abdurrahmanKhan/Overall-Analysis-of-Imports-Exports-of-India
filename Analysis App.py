                ...
                with expander1:      
                        ...
                        if data_file is not None:
                                ...
                                if st.button("Pre-Process imports"):
                                        st.write("**Pre-Processing at the backend is being performed as follows -**")
                                        st.write("**1.** Mean Value Imputation")
                                        st.write("**2.** Drop the duplicate entries")
                                        st.write("**3.** Country attribute has 'UNSCPECIFIED which is replaced with NaN'")
                                        st.write("**4.** Dropping NaN values")
                                        st.write("**5.** Checking for Null Values")
